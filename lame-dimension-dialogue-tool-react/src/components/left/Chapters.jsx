...
const component = ({
    ...
    return (
        <div className="chapters">
                    ...
                    <tbody>
                        {Object.keys(chapters).map((chapterName) => (
                            ...
                            >
                                ...
                                >
                                    {editing === chapterName ? <input type='text' onChange={({target: {value}}) => {setEditValue(value)}} value={editValue} /> : chapterName}
                                </td>
                                {editable ? 
                                <>
                                    { editing === chapterName ?
                                        <td
                                            ...
                                            onClick={() => {
                                                updateChapterName(chapterName, editValue);
                                            }}
                                        >
            ...
            <div>
                <button onClick={onChapterCreate} disabled={!editable}>Add Chapter</button>
            </div>
        </div>
    );
};
