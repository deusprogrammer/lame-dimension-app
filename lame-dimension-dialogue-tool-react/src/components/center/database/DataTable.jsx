    ...
    return (
        <>
            ...
            <table className="data-table">
                    ...
                    {template.map(({ label, key, dataType, collectionType, localized }) => {
                        if (collectionType === 'array') {
                            let collection = localized ? entry[key][defaultLanguage] : entry[key];
                            return (
                                <tbody className="grouped">
                                    ...
                                    <tr><td colSpan={3}><button type="button">Add Element</button></td></tr>
                                </tbody>
                            )
                        }
